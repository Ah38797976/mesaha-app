...
import { BinatnaScreen, BinatnaHomeCard, AdminBinatna } from './binatna/Binatna';
...
/* ===========================================================
   3) HOME
=========================================================== */
function HomeScreen({ c, t, me, partner, couple, phrases, onQuickAction, onOpenChat, onOpenBinatna, toasts }) {
  ...
  return (
    <div className="h-full overflow-y-auto relative">
      ...
      <div className="px-5 -mt-2 relative z-10">
        ...
        <BinatnaHomeCard c={c} onOpen={onOpenBinatna} />
...
function SettingsScreen({ c, dark, setDark, lang, setLang, me, coupleId, partner }) {
  ...
  return (
    <div className="h-full overflow-y-auto px-5 py-5">
      ...
      {me.is_admin && (
        <SettingsBlock c={c} title="🎮 إدارة بيناتنا">
          <AdminBinatna c={c} me={me} />
        </SettingsBlock>
      )}
...
function HomeWithPhrases({ c, t, me, partner, couple, onQuickAction, onOpenChat, onOpenBinatna, toasts }) {
  const [phrases] = useCoupleTable('phrases', couple.id);
  return <HomeScreen c={c} t={t} me={me} partner={partner} couple={couple} phrases={phrases} onQuickAction={onQuickAction} onOpenChat={onOpenChat} onOpenBinatna={onOpenBinatna} toasts={toasts} />;
}
    ...
    body = (
      <div className="h-full flex flex-col">
        <div className="flex-1 min-h-0">
          {tab === 'home' && <HomeWithPhrases c={c} t={t} me={me} partner={partner} couple={couple} onQuickAction={quickAction} onOpenChat={() => setTab('chat')} onOpenBinatna={() => setTab('binatna')} toasts={toasts} />}
          {tab === 'binatna' && <BinatnaScreen c={c} me={me} partner={partner} coupleId={couple.id} onBack={() => setTab('home')} />}
